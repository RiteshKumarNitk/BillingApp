...
export default function UsersClient({ initialUsers, roles, currentUserId }: { initialUsers: any[], roles: any[], currentUserId: string }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await createTenantUser({ name, email, phone, password, tenantRoleId: roleId });
