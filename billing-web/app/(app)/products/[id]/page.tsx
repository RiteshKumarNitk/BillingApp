        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              <div>
                <h3 className="text-lg font-bold text-gray-700 mb-2">Pricing</h3>
              ...
              <div>
                ...
                {product.stock !== null && product.stock <= product.minStockThreshold && (
                  <p className="text-sm text-gray-500 text-red-600 font-bold mt-1">
                    ⚠️ Low Stock Alert!
                  </p>
                )}
              </div>
          ...
          <div className="mt-6 flex justify-end space-x-3">
            ...
            <Link
              href="/products"
              className="bg-gray-200 text-gray-500 px-4 py-2 rounded-md hover:bg-gray-300 transition-colors"
            >
              Back to List
            </Link>
          </div>
