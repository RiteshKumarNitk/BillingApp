...
import {
  ArrowLeft, Package, IndianRupee, Boxes, Info, Plus, Trash2
} from 'lucide-react';
          ...
          <div className="p-6 space-y-5">
            ...
            <div className="pt-4 border-t border-gray-100 grid grid-cols-1 md:grid-cols-2 gap-5">
              <div>
                ...
                <input type="text" name="unit" value={formData.unit} onChange={handleChange} className="w-full rounded-xl border border-gray-300 px-4 py-2.5 text-gray-900 uppercase" />
              </div>
