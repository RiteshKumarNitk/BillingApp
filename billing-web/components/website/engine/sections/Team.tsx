...
export default function Team({ data }: { data: TeamSection['data']; config: WebsiteConfig }) {
  ...
  return (
    <section className="py-20 bg-[var(--theme-background)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-12">
          <h2 className="text-4xl font-extrabold text-gray-900 tracking-tight">{data.title || 'Meet Our Chefs'}</h2>
        </div>
