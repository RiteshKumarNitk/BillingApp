...
export default function AppDownload({ data }: { data: AppDownloadSection['data']; config: WebsiteConfig }) {
  return (
    <section className="py-24 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-[var(--theme-background)] rounded-[40px] p-10 md:p-16 flex flex-col md:flex-row items-center gap-12 relative overflow-hidden">
          <div className="absolute top-0 right-0 w-64 h-64 bg-[var(--theme-primary)]/20 rounded-full blur-3xl transform translate-x-1/2 -translate-y-1/2" />
          <div className="flex-1 z-10">
            ...
            <p className="text-gray-600 leading-relaxed mb-8 max-w-lg">
              {data.subtitle || 'Order ahead and earn points towards free meals, right from your phone.'}
            </p>
          ...
          <div className="flex-1 relative z-10 flex justify-center">
            <div className="w-[280px] h-[550px] bg-white rounded-[40px] border-[8px] border-gray-900 shadow-2xl relative overflow-hidden transform rotate-6 hover:rotate-0 transition-transform duration-500">
              <div className="absolute top-0 inset-x-0 h-6 bg-gray-900 rounded-b-xl w-32 mx-auto z-20" />
